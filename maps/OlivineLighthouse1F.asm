...
.Warps:
	db 5
	warp_def $11, $8, 9, GROUP_OLIVINE_CITY, MAP_OLIVINE_CITY
	warp_def $11, $9, 9, GROUP_OLIVINE_CITY, MAP_OLIVINE_CITY
	warp_def $9, $3, 1, GROUP_OLIVINE_LIGHTHOUSE_2F, MAP_OLIVINE_LIGHTHOUSE_2F
