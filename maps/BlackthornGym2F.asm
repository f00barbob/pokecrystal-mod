...
.PersonEvents:
	db 8
	person_event SPRITE_COOLTRAINER_M, 1 + 4, 4 + 4, OW_LEFT | $1, $0, -1, -1, (PAL_OW_RED << 4) | $82, 1, TrainerCooltrainermCody, -1
	person_event SPRITE_COOLTRAINER_F, 11 + 4, 4 + 4, OW_LEFT | $0, $0, -1, -1, (PAL_OW_RED << 4) | $82, 1, TrainerCooltrainerfFran, -1
	person_event SPRITE_BOULDER, 	2 + 4, 	8 + 4, OW_LEFT | $11, $0, -1, -1, $0, 0, BlackthornGymBoulder, EVENT_BOULDER_IN_BLACKTHORN_GYM_1
	person_event SPRITE_BOULDER, 	3 + 4, 	2 + 4, OW_LEFT | $11, $0, -1, -1, $0, 0, BlackthornGymBoulder, EVENT_BOULDER_IN_BLACKTHORN_GYM_2
	person_event SPRITE_BOULDER, 	7 + 4, 7 + 4, OW_LEFT | $11, $0, -1, -1, $0, 0, BlackthornGymBoulder, EVENT_BOULDER_IN_BLACKTHORN_GYM_3
	person_event SPRITE_BOULDER, 	3 + 4, 	3 + 4, OW_LEFT | $11, $0, -1, -1, $0, 0, BlackthornGymBoulder, -1
	person_event SPRITE_BOULDER, 	1 + 4, 	6 + 4, OW_LEFT | $11, $0, -1, -1, $0, 0, BlackthornGymBoulder, -1
	person_event SPRITE_BOULDER, 	14 + 4, 8 + 4, OW_LEFT | $11, $0, -1, -1, $0, 0, BlackthornGymBoulder, -1
